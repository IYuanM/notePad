...
public class NotesList extends ListActivity {
    ...
    /**
     *
     * 因为他只传过来列的名字，然后去找值，所以没办法在此处做修改
     */
//    private String changeDatestyle(){
//        if(NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE!="modified"){
//            Date a=new Date(Long.parseLong(NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE));
//
...
//        view.setBackground(R.drawable.);
        ...
        SimpleCursorAdapter adapter
            = new SimpleCursorAdapter(
                      ...
                      R.layout.noteslist_item,//这里修改以给时间戳留空          // Points to the XML for a list item
                      cursor,                           // The cursor to get items from
                      dataColumns,//这和下面的参数也要改，必须有时间戳的位置！
                      viewIDs
              );
